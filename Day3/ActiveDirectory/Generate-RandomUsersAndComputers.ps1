...
$OperatingSystems = @("Windows 10 Professional:10.0:0","Windows Vista Enterprise:6.0:2","Windows 7 Enterprise:6.1:2")
$FormFactors = @("LAP-","WKS-","TRM-","TAB-") #Max of four chars here.
