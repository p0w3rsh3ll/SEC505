...
# this number might still be too large when using IPv6 or the Start-End format, and
# the wf.msc console is slow to open with 200 ranges per rule, so the script defaults 
# to only 100 ranges per rule, but feel free to edit the following variable:
