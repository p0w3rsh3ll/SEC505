#########################################################
#.SYNOPSIS
#  Get roles and features for every server in the domain.
#
#.DESCRIPTION
#  This is a starter script to query AD for servers and then
#  inventory the roles and features on each server.  Save
#  the inventory with Export-CliXml.  Add error handling
#  and other polish to use in production. Script only queries
#  Windows Server, not client OS machines.
#
#.PARAMETER SearchBase
#  Distinguished name of Active Directory container where 
#  search for computer accounts for servers should begin.  
#  Defaults to the entire domain of which the local 
