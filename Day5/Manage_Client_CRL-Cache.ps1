...
#   These commands only work on Windows Vista, Server 2008 and later.
#   The CERTUTIL.EXE program is built in by default.
########################################################################
...
# To flush cached CRLs in order to force fresh downloads:
