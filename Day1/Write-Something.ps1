...
# Use of Write-Host is discouraged because it does not send data to any of PowerShell's
# output streams, hence, the data cannot be captured or redirected like normal.
# Only use Write-Host when interacting with humans and when you know that you will
# never need to capture or redirect this data.  In general, prefer using Write-Output
# or Write-Verbose -Verbose instead.  
