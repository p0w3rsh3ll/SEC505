...
class CompanyUser
{
    ...
    {
        Write-Verbose -Verbose "Constructor: CompanyUser" 
        $this.FirstName = $FirstName
        $this.LastName = $LastName
        $this.Title = "Employee" 
    ...
    [Void] Fire()
    { 
        Write-Verbose -Verbose "CompanyUser:Fire()" 
...
class Contractor : CompanyUser
{
    ...
    { 
        Write-Verbose -Verbose "Constructor: Contractor" 
    ...
    [void] Fire()
    {
        ...
        Write-Verbose -Verbose "Contractor:Fire()" 
